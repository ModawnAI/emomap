class jsRMSpan2 extends jsCogtask {
    ...
    create_task_trial() {
        this.task_trial=new jsRMSpan2Trial('trial',this);
    }
...
class jsRMSpan2Trial extends jsTrial {
    constructor (name,task){
        ...
        this.question_string=['한 대','두 대','세 대','네 대','다섯 대','여섯 대','일곱 대','여덟 대','아홉 대','열 대'];
        this.set_default()
    }
    set_default(){
           this.stimuli_isi=[];
    ...
    setup_random_sequence(number_random_sequence){        
        ...
        for (let i=0;i<number_random_sequence.length;i++){
            ...
            a.data=d;
            a.prompt=`<div class="font-message"> 마지막으로 본 캠핑카 ${numstr} 빈지라는 각각 몇 개였나요?</div>`;
