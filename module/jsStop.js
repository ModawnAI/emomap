...
class jsStopTrial extends jsTrial {
    ...
    set_default(){
        ...
        this.ctask.conditions = [
            { stimulus: ['img/fix.png','img/go_left.png','img/go_left.png' ], data: { stim_type: exp.CONGRUENT,stim_id:0, correct_response:0, stim_delay: this.ssd, stimulus:"left/go"} },
            { stimulus: ['img/fix.png','img/go_right.png', 'img/go_right.png'],  data: { stim_type: exp.CONGRUENT,stim_id:1, correct_response:1,stim_delay: this.ssd, stimulus:"right/go"} },
    ...
    setup_ordered_sequence(){
        ...
        for (var i=0;i<this.ctask.sequence_data.length;i++) {
            ...
            let s2='img/' + str+ this.ctask.sequence_data[i].stim_direction +'.png';
